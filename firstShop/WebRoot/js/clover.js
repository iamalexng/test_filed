...
Clover.prototype={  
    ...
    datagrid:function(id,fields,columns){
       	...
       	for(var i=0;i<this.fields.length;i++){
    		...
    		$.each(fields[i],function(key,value) {
    			...
    			if(key=="striped"){fieldsStriped=value;}
    			...
    			if(key=="showHeader"){fieldsShowHeader=value;}
