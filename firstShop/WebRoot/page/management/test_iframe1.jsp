...
<table class="table table-hover table-header table-condensed"><!--  table-hover=鼠标移动  , table-condensed=缩进,table-header 自定义的灰色表头，表头中带有上1px border -->
<!--
